...
CREATE TABLE "public.user_legal_representatives" (
	...
	"user_id" integer NOT NULL,
	"representating_type" varchar(255) NOT NULL,
	"first_name" varchar(255) NOT NULL,
	"second_name" varchar(255) NOT NULL,
	"middle_name" varchar(255) NOT NULL,
	"workplace" varchar(255) NOT NULL,
	"work_experience" integer NOT NULL,
	"speciality_work_experience" integer NOT NULL,
...
CREATE TABLE "public.user_info" (
	...
	"home_city_number_code" integer NOT NULL,
	"home_phone_number" integer NOT NULL,
	"personal_phone_number" integer NOT NULL,
	"educational_institution" varchar(255) NOT NULL,
	"diploma_points" integer NOT NULL,
	"graduation_date" DATE NOT NULL,
	"diploma_number" integer NOT NULL,
	"graduation_speciality" varchar(255),
